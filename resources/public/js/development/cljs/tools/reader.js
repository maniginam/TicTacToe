...
var G__21935 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__21935;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__21936 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__21936,ch);
...
if(("\\" === ch__$1)){
var ch_21937__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_21937__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_21937__$2);
} else {
}
...
var G__21949 = cljs.core.conj_BANG_.call(null,a,form);
a = G__21949;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__21950 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__21951 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__21951;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__21950;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__21952 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21952,(0),null);
var start_column = cljs.core.nth.call(null,vec__21952,(1),null);
...
var vec__21955 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21955,(0),null);
var end_column = cljs.core.nth.call(null,vec__21955,(1),null);
...
var vec__21958 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21958,(0),null);
var start_column = cljs.core.nth.call(null,vec__21958,(1),null);
...
var vec__21961 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21961,(0),null);
var end_column = cljs.core.nth.call(null,vec__21961,(1),null);
...
var vec__21964 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21964,(0),null);
var start_column = cljs.core.nth.call(null,vec__21964,(1),null);
...
var vec__21967 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21967,(0),null);
var end_column = cljs.core.nth.call(null,vec__21967,(1),null);
...
switch (G__21976) {
case "\\":
var G__21980 = (function (){var G__21977 = sb;
G__21977.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__21977;
})();
var G__21981 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__21980;
ch = G__21981;
continue;
...
break;
default:
var G__21982 = (function (){var G__21978 = sb;
G__21978.append(ch);

return G__21978;
})();
var G__21983 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__21982;
ch = G__21983;
continue;
...
var vec__21984 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21984,(0),null);
var end_column = cljs.core.nth.call(null,vec__21984,(1),null);
...
var vec__21987 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21987,(0),null);
var column = cljs.core.nth.call(null,vec__21987,(1),null);
...
var vec__21992 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21992,(0),null);
var column = cljs.core.nth.call(null,vec__21992,(1),null);
...
var vec__21997 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21997,(0),null);
var column = cljs.core.nth.call(null,vec__21997,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__22002 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22002,(0),null);
var start_column = cljs.core.nth.call(null,vec__22002,(1),null);
...
var vec__22005 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22005,(0),null);
var end_column = cljs.core.nth.call(null,vec__22005,(1),null);
...
var G__22008 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__22008,true,null,opts,pending_forms);
...
var G__22009 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__22009)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__22009)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__22009)){
...
var _STAR_suppress_read_STAR__orig_val__22010 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__22011 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__22011;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__22010;
}});
...
var G__22012 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__22012,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__22012,rdr,first_line);
...
var G__22016 = matched;
var G__22017 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__22016;
finished = G__22017;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__22018 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__22019 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__22019;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__22018;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__22020 = cljs.tools.reader.arg_env;
var arg_env_temp_val__22021 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__22021;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__22022 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22022,"(");
...
var G__22023 = (i + (1));
var G__22024 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__22020;
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__22025 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__22025);
...
var G__22029 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__22028;
key_vals = G__22029;
continue;
} else {
...
var gensym_env_orig_val__22033 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__22034 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__22034;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__22033;
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__22035 = token;
var G__22035__$1 = (((G__22035 == null))?null:cljs.core.subs.call(null,G__22035,(1)));
var G__22035__$2 = (((G__22035__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22035__$1));
var G__22035__$3 = (((G__22035__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22035__$2));
var G__22035__$4 = (((G__22035__$3 == null))?null:cljs.core.symbol.call(null,G__22035__$3));
if((G__22035__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__22035__$4);
}
})():(function (){var G__22036 = token;
var G__22036__$1 = (((G__22036 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22036));
if((G__22036__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22036__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
}catch (e22043){if((e22043 instanceof Error)){
var e = e22043;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__22047,reader){
...
var opts = map__22048__$1;
var eof = cljs.core.get.call(null,map__22048__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq22054){
var G__22055 = cljs.core.first.call(null,seq22054);
var seq22054__$1 = cljs.core.next.call(null,seq22054);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22055,seq22054__$1);
});


//# sourceMappingURL=reader.js.map?rel=1598038761695
