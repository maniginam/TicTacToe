...
return (new CustomEvent(event_name,(function (){var obj26849 = ({"detail":data});
return obj26849;
})()));
} else {
...
var f = (function (){var pred__26856 = cljs.core._EQ_;
var expr__26857 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26856.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26857))){
return ((function (pred__26856,expr__26857){
return (function (p1__26850_SHARP_){
return console.warn(p1__26850_SHARP_);
});
;})(pred__26856,expr__26857))
} else {
if(cljs.core.truth_(pred__26856.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26857))){
return ((function (pred__26856,expr__26857){
return (function (p1__26851_SHARP_){
return console.debug(p1__26851_SHARP_);
});
;})(pred__26856,expr__26857))
} else {
if(cljs.core.truth_(pred__26856.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26857))){
return ((function (pred__26856,expr__26857){
return (function (p1__26852_SHARP_){
return console.error(p1__26852_SHARP_);
});
;})(pred__26856,expr__26857))
} else {
return ((function (pred__26856,expr__26857){
return (function (p1__26853_SHARP_){
return console.log(p1__26853_SHARP_);
});
;})(pred__26856,expr__26857))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26860){
...
var opts = map__26861__$1;
var eval_fn = cljs.core.get.call(null,map__26861__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26863_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__26865,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1598038770903
