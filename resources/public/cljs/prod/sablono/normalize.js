...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__14078){
var vec__14079 = p__14078;
var _ = cljs.core.nth.call(null,vec__14079,(0),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__14082_SHARP_){
return (((p1__14082_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__14082_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__14083,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__14083;
}
});
...
var len__4736__auto___14086 = arguments.length;
var i__4737__auto___14087 = (0);
while(true){
if((i__4737__auto___14087 < len__4736__auto___14086)){
args__4742__auto__.push((arguments[i__4737__auto___14087]));

var G__14088 = (i__4737__auto___14087 + (1));
i__4737__auto___14087 = G__14088;
continue;
} else {
}
break;
...
var G__14085 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_.call(null,classes)))){
return cljs.core.assoc.call(null,G__14085,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__14085;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq14084){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq14084));
}));
...
var vec__14091 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__14091,(0),null);
var names = cljs.core.nth.call(null,vec__14091,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,(function (p1__14089_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__14089_SHARP_))){
return p1__14089_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__14090_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__14090_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__14094){
var vec__14095 = p__14094;
var seq__14096 = cljs.core.seq.call(null,vec__14095);
var first__14097 = cljs.core.first.call(null,seq__14096);
var seq__14096__$1 = cljs.core.next.call(null,seq__14096);
var tag = first__14097;
var content = seq__14096__$1;
...
var vec__14098 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__14098,(0),null);
var id = cljs.core.nth.call(null,vec__14098,(1),null);
var class$ = cljs.core.nth.call(null,vec__14098,(2),null);
