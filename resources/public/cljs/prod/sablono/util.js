...
var sablono$util$ToString$to_str$dyn_14041 = (function (x){
...
return sablono$util$ToString$to_str$dyn_14041.call(null,x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_14042 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_14042.call(null,x);
}
});
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq14043){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq14043));
}));
...
var vec__14047 = cljs.core.name.call(null,k).split("-");
...
var first_word = first__14049;
var words = seq__14048__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__14050){
...
return cljs.core.update.call(null,G__14054,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__14054;
}
} else {
