...
var sablono$interpreter$IInterpreter$interpret$dyn_14103 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_14103.call(null,this$);
}
});
...
var x14104_14105 = ctor.prototype;
(x14104_14105.onChange = (function (event){
var this$ = this;
...
(x14104_14105.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__14109) {
case "input":
var G__14110 = ((cljs.core.object_QMARK_.call(null,props))?props.type:false);
switch (G__14110) {
case "radio":
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq14113){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14114,G__14115,seq14113__$2);
}));
...
var vec__14120 = sablono.normalize.element.call(null,element);
var type = cljs.core.nth.call(null,vec__14120,(0),null);
var attrs = cljs.core.nth.call(null,vec__14120,(1),null);
var content = cljs.core.nth.call(null,vec__14120,(2),null);
