...
return cljs.core.not.call(null,cljs.core.some.call(null,(function (p1__6275_SHARP_){
return cljs.core.contains_QMARK_.call(null,excludes,p1__6275_SHARP_);
}),tags));
}
});
...
var context_seq = cljs.core.tree_seq.call(null,(function (p1__6279_SHARP_){
return (!((p1__6279_SHARP_ == null)));
}),(function (p1__6280_SHARP_){
return cljs.core.deref.call(null,p1__6280_SHARP_.children);
}),context);
...
var context_seq = cljs.core.tree_seq.call(null,(function (p1__6281_SHARP_){
return (!((p1__6281_SHARP_ == null)));
}),(function (p1__6282_SHARP_){
return cljs.core.deref.call(null,p1__6282_SHARP_.children);
}),context);
return cljs.core.map.call(null,(function (p1__6283_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"tag-set","tag-set",-711527597)],[p1__6283_SHARP_,speclj.tags.tags_for.call(null,p1__6283_SHARP_)]);
}),context_seq);
});
