...
return cljs.core.not.call(null,cljs.core.some.call(null,(function (p1__4046_SHARP_){
return cljs.core.contains_QMARK_.call(null,excludes,p1__4046_SHARP_);
}),tags));
}
});
...
var context_seq = cljs.core.tree_seq.call(null,(function (p1__4050_SHARP_){
return (!((p1__4050_SHARP_ == null)));
}),(function (p1__4051_SHARP_){
return cljs.core.deref.call(null,p1__4051_SHARP_.children);
}),context);
...
var context_seq = cljs.core.tree_seq.call(null,(function (p1__4052_SHARP_){
return (!((p1__4052_SHARP_ == null)));
}),(function (p1__4053_SHARP_){
return cljs.core.deref.call(null,p1__4053_SHARP_.children);
}),context);
return cljs.core.map.call(null,(function (p1__4054_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"tag-set","tag-set",-711527597)],[p1__4054_SHARP_,speclj.tags.tags_for.call(null,p1__4054_SHARP_)]);
}),context_seq);
});
