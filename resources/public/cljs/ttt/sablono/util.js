...
var sablono$util$ToString$to_str$dyn_31090 = (function (x){
...
return sablono$util$ToString$to_str$dyn_31090.call(null,x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_31091 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_31091.call(null,x);
}
});
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq31092){
...
var vec__31096 = cljs.core.name.call(null,k).split("-");
...
var first_word = first__31098;
var words = seq__31097__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__31099){
...
return cljs.core.update.call(null,G__31103,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__31103;
}
} else {
