...
var sablono$interpreter$IInterpreter$interpret$dyn_6158 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_6158.call(null,this$);
}
});
...
var x6159_6160 = ctor.prototype;
(x6159_6160.onChange = (function (event){
var this$ = this;
...
(x6159_6160.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__6164) {
case "input":
var G__6165 = ((cljs.core.object_QMARK_.call(null,props))?props.type:false);
switch (G__6165) {
case "radio":
...
args__4742__auto__.push((arguments[i__4737__auto___6172]));
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq6168){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6169,G__6170,seq6168__$2);
}));
...
var vec__6175 = sablono.normalize.element.call(null,element);
var type = cljs.core.nth.call(null,vec__6175,(0),null);
var attrs = cljs.core.nth.call(null,vec__6175,(1),null);
var content = cljs.core.nth.call(null,vec__6175,(2),null);
