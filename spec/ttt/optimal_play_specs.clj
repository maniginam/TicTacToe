...
(describe "Tests for an optimal box to play"
  ...
  (it "gets box scores for 4x4 board"
    (should= [10] (get-box-scores ["X" "X" "X" 3 "O" "O" "O" "X" "O" "O" "O" "X" "X" "O" "O" "O"] 1 0))
    (should= [10 0] (get-box-scores ["X" "X" "X" 3 "O" "O" "O" "X" "O" "O" "O" "X" "X" "O" "O" 15] 1 0))
    (should= [10 0 -9] (get-box-scores ["X" "X" "X" 3 "O" "O" "O" "X" "O" "O" "O" 11 "X" "O" "O" 15] 1 0))
    (should= [10 -9 0 -9] (get-box-scores ["X" "X" "X" 3 4 "O" "O" "X" "O" "O" "O" 11 "X" "O" "O" 15] 1 0))
    (should= [10 -9 -9 0 -9] (get-box-scores ["X" "X" "X" 3 4 "O" 6 "X" "O" "O" "O" 11 "X" "O" "O" 15] 1 0))
    (should= [-9 -9 -9 -9 0 -9] (get-box-scores [0 "X" "X" 3 4 "O" 6 "X" "O" "O" "O" 11 "X" "O" "O" 15] 1 0))
    (should= [-9 -9 -9 -9 0 -9 -9] (get-box-scores [0 "X" "X" 3 4 "O" 6 "X" "O" "O" "O" 11 "X" "O" 14 15] 1 0))
    (should= [-9 -9 -9 -9 0 -9 -9 -9] (get-box-scores [0 "X" "X" 3 4 "O" 6 "X" "O" "O" "O" 11 "X" 13 14 15] 1 0))
    (should= [-9 -9 -9 -9 0 -9 -9 -9 -9] (get-box-scores [0 "X" "X" 3 4 "O" 6 "X" "O" "O" "O" 11 12 13 14 15] 1 0))
    ;(should= [-9 -9 -9 -9 0 -9 -9 -9 -9] (get-box-scores [0 "X" "X" 3 4 "O" 6 "X" "O" "O" 10 11 12 13 14 15] 1 0)))
    )
    )
